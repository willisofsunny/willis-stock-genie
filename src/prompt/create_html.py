...
data.research_results.institutional_investor
    ...
    <script>
        ...
        function renderAnalysis() {
            ...
            const analysisData = [
                ...
                { id: 'institutional_investor', title: '三大法人资金分析', icon: 'fas fa-users', content: research.institutional_investor || '暂无数据' },
